...
There are a number of programming standards that the framework follows to give you a consistent
...
class OrderComponent {
  ...
  static constraints = {
    userName(maxSize: FieldSizes.MAX_CODE_LENGTH, blank: false, nullable: false)
  }
