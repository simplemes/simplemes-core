...
This requires use of the framework .jar files are described in <<Designer Studio Setup>>.
...
. Add a JAR file for the eframe module or add the class directories for the build area
  on your system. (.JAR files seems to work more reliably).
. Restart the Studio.
